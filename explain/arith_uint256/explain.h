...
today i will explain 2 files: arith_uint256.h & arith_uin256.cpp
...
realising us in sum the perfect monetary and fully digitized Banking System for todays times for the Internet. And in a decentralised way :)
					...
					we reached the arith_uint256.* files in this process dealing with functionality for
					basic maths interactions for Blobs (Binary Large Objects)
