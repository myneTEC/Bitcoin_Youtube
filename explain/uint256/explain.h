...
today i will explain 2 files: uint256.h & uin256.cpp
...
realising us in sum the perfect monetary and fully digitized Banking System for todays times for the Internet. And in a decentralised way :)
					...
					we reached the uint256.* files in this process dealing with functionality for Blobs (Binary Large Objects).
